 ...
 echo $_SESSION['homeuser']['uface'] ?>" />-->
	...
	<!--内容部分start-->
		<div class="content">			
			...
			<div class="send_btn">
				<div class="send">
					<a href="index.php?m=home&c=post&a=create&cid=<?php echo ($cid); ?>">
			...
			<div class="post_list" >
				...
				<div class="post_content">
					<table cellspacing=0 cellpadding=0 width='100%'>
						...
						<tr>
							<td class="list_title">
							<a href="/index.php?m=home&c=post&a=show&pid=<?php echo ($v['pid']); ?>&cid=<?php echo ($v['cid']); ?>">
							
							<?php
 if( !$v['is_ding'] ){ echo $v['title']; }else{ echo $v['title'],'<img src="./Public/Home/images/5-120601154100.gif" />'; } if( !$v['is_jing'] ){ echo ''; }else{ echo '<img src="./Public/Home/images/jh.png" />'; } ?>
							</a></td>
							<td class="list_author">
								<?php
 $user = M('user') ->find($v['uid']); if( empty($user) ){ echo ''; }else{ echo $user['uname']; } ?></td>
							<td class="list_count">
							<?php
 echo '&nbsp;&nbsp;&nbsp;&nbsp;',$v['r_cnt']; echo '/'; echo $v['v_cnt']; ?>
							</td>
							<td class="list_ptime"><?php echo date('Y-m-d H:i:s',$v['updated_at']) ;?></td>
						</tr>
						<?php else: ?>
