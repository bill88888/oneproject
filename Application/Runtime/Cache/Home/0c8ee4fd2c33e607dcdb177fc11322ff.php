...
<!--网页顶部end-->
 ...
 echo $_SESSION['homeuser']['uface'] ?>" />-->
	...
	<h1 style="margin-left:45%;">修改密码</h1>
	<hr>
	<div class="content">			
			<form action="/index.php?m=home&c=user&a=updatemi&uid=<?php echo ($_SESSION['homeuser']['uid']); ?>" method="post" enctype="multipart/form-data">
				<table align="center" width="300" height="60">
					<tr>
						<td><label>用户名:</label></td>
						<td><input type="text" name="uname" value="<?php echo ($_SESSION['homeuser']['uname']); ?>" readonly></td>
					</tr>
					...
					<tr>
						...
						<td><input type="password" name="renupwd" value=""></td>
					</tr>
