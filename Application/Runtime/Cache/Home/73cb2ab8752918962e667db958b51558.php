...
<!--网页顶部end-->
 ...
 echo $_SESSION['homeuser']['uface'] ?>" />-->
		...
		<h1 style="margin-left:45%">修改个人信息</h1>	
		<hr>
	<!--内容部分start-->
		<div class="content">			
			<form action="/index.php?m=home&c=user&a=update&uid=<?php echo ($_SESSION['homeuser']['uid']); ?>" method="post" enctype="multipart/form-data">
				<table align="center" width="300" height="60">
					<tr>
						<td><label>用户名:</label></td>
						<td><input type="text" name="uname" value="<?php echo ($_SESSION['homeuser']['uname']); ?>"></td>
					</tr>
					<tr>
						<td><label>头像:</label></td>
						<td>
							<input type="file" name="uface" value="<?php echo ($_SESSION['homeuser']['uface']); ?>">
							
							<img src="/Public/Uploads/<?php echo ($_SESSION['homeuser']['uface']); ?>" width="100px" />
						</td>

					</tr>
					<tr>
						<td><label>手机号:</label></td>
						<td><input type="text" name="tel" value="<?php echo ($_SESSION['homeuser']['tel']); ?>"></td>
					</tr>
