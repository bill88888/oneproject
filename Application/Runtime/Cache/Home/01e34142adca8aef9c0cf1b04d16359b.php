		...
		<div id="header">
		  ...
		  <div id="logo_login">
			...
			<div id="login">
				...
				<form action="/index.php?m=home&c=index&a=dologin" method="post">
			  <table>
				<tr>
				  <td>
					<label>帐号</label>
				...
				<tr>
				  ...
				  <td>
					<a href="/index.php?m=home&c=index&a=create">立即注册</a>
				  </td>
				</tr>
			  </table>
				</form>
				<?php else: ?>
						<p style="font-size:25px; text-align:right; line-height:70px;">
						Welcome,<?php echo ($_SESSION['homeuser']['uname']); ?> 
						<a href="/index.php?m=home&c=index&a=logout" style="color:#1E0E8F">退出</a>
						<p>
				<?php endif; ?>
			</div>
			<!--登陆部分start-->
