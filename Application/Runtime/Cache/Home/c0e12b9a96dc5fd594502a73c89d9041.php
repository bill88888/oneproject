				...
				<table cellpadding="0" cellspacing="0">
				  <tr>
					...
					<td class="search_input">
					  <input type="text" name="pname" x-webkit-speech speech placeholder="请输入搜索内容" />
					</td>
					<td class="search_select">
					  <a href="/index.php?m=home&c=post&a=indexAll">帖子</a>
			...
			<div class="post_list" >
				...
				<div class="post_content">
					<table cellspacing=0 cellpadding=0 width='100%'>
						...
						<tr>
							<td class="list_title"><a href="/index.php?m=home&c=post&a=show&pid=<?php echo ($v['pid']); ?>&cid=<?php echo ($v['cid']); ?>"><?php echo ($v['title']); ?></a></td>
