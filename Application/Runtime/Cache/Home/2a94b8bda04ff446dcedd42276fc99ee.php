		...
		<div class="content">
            ...
            <div class="section">
                ...
                <div class="section_title">
                  <span class="section_title_left"><?php echo ($v['pname']); ?></span>
                  <span class="section_title_right">分区版主：<a href="">
                  	<?php
 $uid = $v['uid']; $user = M('user') ->where("uid=$uid") ->find(); if( empty($user) ){ echo ''; }else{ echo $user['uname']; } ?></a></span>
                </div>
                <!--分区标题部分end-->
                ...
                <div class="section_content">
                	<?php foreach( $v['cate'] as $key=>$value ): ?>
                  <table cellspacing="0" celpadding="0" style="width:33.33%;float:left;">
                    <tr>
                      <td width="33%">
                        ...
                        <dl>
                          <dd class="dd_title"><a href="/index.php?m=home&c=post&a=index&cid=<?php echo ($value['cid']); ?>"><?php echo ($value['cname']); ?></a></dd>
                          <dd>
                            <em>主题：54</em>,
                            <em>帖子：244</em>
                          </dd>
		...
		<div class="content">			
			...
			<div class="send_btn">
				<div class="send">
					<a href="index.php?m=home&c=post&a=sCreate">
			...
			<div class="post_list" >
				...
				<div class="post_content">
					<table cellspacing=0 cellpadding=0 width='100%'>
						<tr>
							<td class="list_title"><a href="/index.php?m=home&c=post&a=show&pid=<?php echo ($post['pid']); ?>&cid=<?php echo ($post['cid']); ?>"><?php echo ($post['title']); ?></a></td>
							<td class="list_author">
								<?php
 $uid = $post['uid']; $user = M('user') ->find($uid); if( empty($user) ){ echo ''; }else{ echo $user['uname']; } ?></td>
							<td class="list_count"></td>
							<td class="list_ptime"><?php echo date('Y-m-d H:i:s',$post['updated_at']) ;?></td>
						</tr>
					</table>
				</div>
				<!--帖子列表内容部分end-->
