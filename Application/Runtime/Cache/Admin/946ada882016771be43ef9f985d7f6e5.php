    ...
    <!--/sidebar-->
        ...
        <div class="result-wrap">
            <div class="result-content">
                ...
                <form action="/index.php?m=Admin&c=User&a=updatemi&uid=<?php echo ($_SESSION['adminuser']['uid']); ?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th><i class="require-red">*</i>账号：</th>
                                <td>
                                    <input class="common-text required" id="title" name="uname" size="50" value="<?php echo ($_SESSION['adminuser']['uname']); ?>" type="text" readonly>
                                </td>
                            </tr>
                            <tr>
