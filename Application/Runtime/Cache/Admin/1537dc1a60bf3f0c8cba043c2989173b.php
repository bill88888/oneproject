                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td><?php  $parts = M('part') ->find($v['pid']); echo $parts['pname']; ?>
                            </td>
                            <td><?php echo ($v['cname']); ?></td>
                            <td><?php echo date('Y-m-d H:i:s',$v['created_at']);?></td>
                            <td>
                                <a class="link-update" href="/index.php?m=admin&c=cate&a=edit&cid=<?php echo ($v['cid']); ?>">修改</a>
                                <a class="link-del" href="/index.php?m=admin&c=cate&a=del&cid=<?php echo ($v['cid']); ?>">删除</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </table>
